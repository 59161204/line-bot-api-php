  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อยากทราบยอด COVID-19 ครับ")||($text == "อยากทราบยอดCOVID-19")||($text == "อยากทราบยอด covid-19 ครับ")){
			...
			$reply_message = '"รายงานสถานการณ์ ยอดผู้ติดเชื้อไวรัสโคโรนา 2019 (COVID-19) ในประเทศไทย"'.$SA;
// 			."ผู้ป่วยสะสม	  จำนวน: ".$SA."    ราย".
// 			."ผู้เสียชีวิต	    จำนวน: ".$DA."	ราย".
// 			."รักษาหาย	จำนวน: "'.$TA.'"    ราย".;
// 			."ผู้รายงานข้อมูล".$ME;
		}
