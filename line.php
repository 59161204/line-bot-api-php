  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อยากทราบยอด COVID-19 ครับ")||($text == "อยากทราบยอดCOVID-19")||($text == "อยากทราบยอด covid-19 ครับ")){
			...
			$reply_message = '"ผู้ป่วยสะสม	  จำนวน: "'.$SA.'"ราย"';
			$reply_message = '"ผู้เสียชีวิต	    จำนวน: "'.$DA.'"ราย"';
			$reply_message = '"รักษาหาย	จำนวน: "'.$TA.'"ราย"';
			$reply_message = '"ผู้รายงานข้อมูล: นายกษิดิศ มากท้วม"';
		}
